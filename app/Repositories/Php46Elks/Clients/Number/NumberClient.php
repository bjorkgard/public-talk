...
namespace App\Repositories\Php46Elks\Clients\Number;

use App\Repositories\Php46Elks\Clients\BaseClient;
use App\Repositories\Php46Elks\Clients\Number\Resources\Number;
use App\Repositories\Php46Elks\Exceptions\InvalidNumberCapabilityException;
use App\Repositories\Php46Elks\Exceptions\InvalidNumberCategoryException;
use App\Repositories\Php46Elks\Exceptions\InvalidNumberOptionException;
...
class NumberClient extends BaseClient
{
    ...
    public function allocate(string $country, $capabilities, string $category, array $options = []): Number
    {
        ...
        // perform request
        $request = $this->getGuzzleClient()->post('numbers', [
            GuzzleHttpRequestOptions::FORM_PARAMS => $this->getOptions()
        ]);
